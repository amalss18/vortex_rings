...
def vField3d(C, r, Nvec, np, f, dx, gamma, Rcore=None):
    """
    ...
    [Z,Y,X] = N.mgrid[zmin:zmax:dx, ymin:ymax:dx, xmin:xmax:dx]
    print(X.shape)
...
if __name__=="__main__":
    import numpy as N
    from mayavi import mlab
    # vField3d(C=N.array([[1,0,0],[0,0,0]]), r=12, Nvec=N.array([[1,0,0],[1,0,0]]), np=60, f=1.25, Rcore=4)
    x, y, z, u, v, w = vField3d(C=N.array([[1,0,0],[0,0,0]]), r=1.0, Nvec=N.array([[1,0,0],[1,0,0]]), np=15, f=1.5, dx = 0.1, gamma = 0.0075, Rcore=0.2)
    # return x, y, z, u, v, w
